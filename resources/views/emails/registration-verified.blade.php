...
<body>
    <div class="container">
        ...
        <p>Pendaftaran Anda pada platform <strong>OSCAR BPMI</strong> telah <strong>berhasil diverifikasi</strong>. Anda kini sudah dapat menggunakan seluruh layanan yang tersedia.</p>

        <p>Silakan mulai mengajukan permintaan layanan sesuai kebutuhan Anda.</p>

        <a class="btn" href="{{ $url }}" target="_blank">Ajukan Layanan Sekarang</a>
