...
<body>
    <div class="container">
        ...
        <p>Status permintaan layanan Anda pada platform <strong>OSCAR BPMI</strong> telah mengalami perubahan. Berikut adalah informasi pembaruan status terbaru:</p>
        ...
        <a class="btn" href="{{ $url }}/layanan" target="_blank">Lihat Status Terbaru</a>
